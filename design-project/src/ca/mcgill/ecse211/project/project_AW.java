...
public class project_AW {
   ...
   */
  public static final double WHEEL_RAD = 2.13; //TODO: FIND WHEELRAD FOR NEW ROBOT

  /**
   * The width (in cm) of the robot measured from the center of the left wheel to the center of the
   * right wheel
   */
  public static final double TRACK = 15.56; //TODO: FIND TRACK FOR NEW ROBOT
 ...
 // variable to record button clicked by user
   ...
   //   (new Thread(display)).start();
      ...
      NavigationWithCorr navCorrection = new NavigationWithCorr(odometer, left, right, leftcsData, rightcsData);
      navCorrection.navigateTo(1, 1, 1, 5);
      navCorrection.locaAtTunnel(1,5);
      navCorrection.navigateTo(1, 5, 1, 10);
      navCorrection.locaAtTunnel(1,10);
      navCorrection.navigateTo(1, 10, 1, 14);
      navCorrection.locaAtTunnel(1,14);
...
//      Navigation nav = new Navigation(odometer);
//      
//      System.out.println("x: " + tunnel_LL_x);
//      System.out.println("y: " + tunnel_LL_y);
...
//        nav.turnTo(90); //TODO: MIGHT NEED TO FIX TURNTO   //!!!!!!!!!!!!!!!!!!!!
//        tunnelLength = tunnel_UR_x - tunnel_LL_x + 1; //+1 to account for half tile before and after // !!!!!!!!!!!!!!!!!!!!!!!!!!!!
